...
class RotateToPca:
    ...
    Parameters
    ----------
        loaded_datasets : smefit_tutorial.loader.DataTuple
            loaded datasets
        coefficients : smefit_tutorial.coeffiecients.CoefficientManager
            coeffiecient list
        config : dict
...
def impose_constrain(dataset, coefficients, update_quad=False):
    ...
    Parameters
    ----------
    dataset: smefit_tutorial.loader.DataTuple
        loaded datasets
    coefficient: smefit_tutorial.coefficients.CoefficienManager
        coefficient manager
...
class PcaCalculator:
    ...
    dataset: smefit_tutorial.loader.DataTuple
        loaded datasets
    coefficients:  smefit_tutorial.coefficients.CoefficienManager
        coefficient manager
    latex_names: dict
